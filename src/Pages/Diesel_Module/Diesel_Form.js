...
const DieselForm = ({ formData, handleChange, isEditing, closeModal }) => {
  const handleSubmit = async (e) => {
    e.preventDefault();

    const url = isEditing
      ? `https://api.example.com/diesel/${formData.id}`  // Update existing record
      : "https://api.example.com/diesel";  // Add new record
